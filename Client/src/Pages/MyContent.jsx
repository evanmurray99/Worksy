...
export default function MyContent({}) {
  ...
  const updateUser = (firstName, lastName, email, password, bio) => {
    ...
    const updateBio =
      "http://localhost:3001/api/users/" + user._id + "/update-bio";
  ...
  let postList = services
    ? postToElement(services, user, setServices, categoryList, services)
    : null;
